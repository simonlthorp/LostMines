#include "FireballWall.h"

FireballWall::FireballWall(SDL_Texture* texture, float x, float y) : Entity(GameScene::manager) {
	//int sc;
	//float destX, destY;
	//Add components
	this->addComponent<TransformComponent>(x, y, 32, 32, 1);
	//this->addComponent<SpriteComponent>(texture);
	this->addComponent<ColliderComponent>("FireballWall");
...
//sets position
void FireballWall::setPosition(float x, float y) {
